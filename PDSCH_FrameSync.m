...
PilotParam_sync = PDSCH_PilotParamInit(TM, CFI, ...
    ...
    dmrs_TypeA_Position, n_s_f_sync, SystemParam.PDSCH_NumSymbols);
PilotParam_sync = PDSCH_ShiftPilotFrequency(PilotParam_sync, ...
    SystemParam.RBStart, SystemParam.Nc_RB);
